...
<div class="pt-5">
    ...
    <div class="card-deck" style="height:inherit">
      ...
      <img class="card-img-top pt-2" src="img/baiust.gif"  width="100px" height="400px" alt="Card image cap">
      <div class="card-body">
    ...
    <div class="card border-primary px-5" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2)" >
    <img class="card-img-top" src="img/ndc.jpg" width="100px" height="400px" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Higher Secondary Certificate (2013 - 2015)</h5>
      <p class="card-text">Notre Dame College, Dhaka, Bangladesh</p>
      <a href="https://notredamecollege-dhaka.com/" target="_blank" class="btn btn-primary">NDC Website</a>
    </div>
  </div>
  <div class="card border-primary px-5" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2)">
  <img class="card-img-top" src="img/acps.jpg" width="100px" height="400px" alt="Card image cap">
  <div class="card-body">
